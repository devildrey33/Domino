/* 
    Domino ThreeJS creado por Josep Antoni Bover Comas el 19/01/2019
        ...
        Ultima modificaci贸n el 28/02/2019
*/
...
//    this.Jugador          = [];     // TODO por eliminar
    ...
    // Funci贸n que devuelve el jugador que empieza la mano
        ...
        // El resto de turnos 
            ...
            if (Posibilidades.length > 0)  {
                ...
                if (this.JugadorActual !== 0) {
                    // IA 1.0
                    // TODO : Segun la dificultad se hace un rand para ver si toca el movimiento l骻ico, o un movimiento al azar)
...
//            this.MostrarMensaje(this.JugadorActual, "Jugador" + J +  " ha bloqueado la mano!", "verde");
            ...
            //                          ganando aquella que totalice una suma menor. En caso de empate, la mano no cuenta a efectos de puntuaci贸n.
            var P1 = this.ContarPuntos(0), P2 = this.ContarPuntos(1), P3 = this.ContarPuntos(2), P4 = this.ContarPuntos(3);
...
/*            if (this.PuntosEquipo1 >= this.Opciones.PuntosPorPartida || this.PuntosEquipo2 >= this.Opciones.PuntosPorPartida) { // Se ha terminado la partida
    ...
    // Funci贸n para mostrar un mensaje especifico para un jugador
...
//        var Rama = "izquierda";
        if (this.JugadorActual === 0) {
            ...
            for (var i = 0; i < 7; i++) {
                // Es muy importante saber si la ficha est谩 hover o no

...
//    this.Jugador          = [];     // TODO por eliminar
    ...
    // Funci√≥n que devuelve el jugador que empieza la mano
        ...
        // El resto de turnos 
            ...
            if (Posibilidades.length > 0)  {
                ...
                if (this.JugadorActual !== 0) {
                    // IA 1.0
                    // TODO : Segun la dificultad se hace un rand para ver si toca el movimiento lÛgico, o un movimiento al azar)
...
//            this.MostrarMensaje(this.JugadorActual, "Jugador" + J +  " ha bloqueado la mano!", "verde");
            ...
            //                          ganando aquella que totalice una suma menor. En caso de empate, la mano no cuenta a efectos de puntuaci√≥n.
            var P1 = this.ContarPuntos(0), P2 = this.ContarPuntos(1), P3 = this.ContarPuntos(2), P4 = this.ContarPuntos(3);
...
/*            if (this.PuntosEquipo1 >= this.Opciones.PuntosPorPartida || this.PuntosEquipo2 >= this.Opciones.PuntosPorPartida) { // Se ha terminado la partida
    ...
    // FunciÛn para mostrar un mensaje especifico para un jugador
...
//        var Rama = "izquierda";
        if (this.JugadorActual === 0) {
            ...
            for (var i = 0; i < 7; i++) {
                // Es muy importante saber si la ficha est√° hover o no
